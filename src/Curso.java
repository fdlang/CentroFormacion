...
public class Curso {
    private int cod; // Variable privada de tipo string que sera utilizada para el codigo del curso. 
    ...
    public Curso(int cod, String nombre, String descrip, Profesor profesor, ArrayList<Alumno> alumnos) {
        this.cod = cod;
        this.nombre = nombre;
